        ...
        <form action="/project-flower/cart/cart.php?act=submit" method="POST">
            <div class="row align-items-stretch mb-5">
                ...
                <tr>
                    ...
                    <th><input id="bill_input" name="customer" type="text" value="<?php if(isset($_SESSION['user_fullName'])) echo $_SESSION['user_fullName'];?>"></th>
                </tr>
                <tr>
                    <th id="bill_field">Số điện thoại: </th>
                    <th><input id="bill_input" name="phone" type="text" value="<?php if(isset($_SESSION['phone'])) echo $_SESSION['phone'];?>"></th>
                </tr>
                <tr>
                    <th id="bill_field">Email: </th>
                    <th><input id="bill_input" name="email" type="text" value="<?php if(isset($_SESSION['email'])) echo $_SESSION['email'];?>"></th>
                </tr>
                <tr>
