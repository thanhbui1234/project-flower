            ...
            <div class="row align-items-stretch mb-5">
                <table class="table shadow p-3 mb-5 bg-body rounded  table-condensed table-bordered ">
                    <tr>
                        ...
                        <th><input id="bill_input" name="customer" type="text"
                                value="<?php if(isset($_SESSION['user_fullName'])) echo $_SESSION['user_fullName'];?>">
                        </th>
                    </tr>
                    <tr>
                        <th id="bill_field">Số điện thoại: </th>
                        <th><input id="bill_input" name="phone" type="text"
                                value="<?php if(isset($_SESSION['phone'])) echo $_SESSION['phone'];?>"></th>
                    </tr>
                    <tr>
                        <th id="bill_field">Email: </th>
                        <th><input id="bill_input" name="email" type="text"
                                value="<?php if(isset($_SESSION['email'])) echo $_SESSION['email'];?>"></th>
                    </tr>
                    <tr>
                        <th id="bill_field">Địa chỉ: </th>
                        <th><input required id="bill_input" name="address" type="text"
                                value="<?php if(isset($_SESSION['address'])) echo $_SESSION['address'];?>"></th>
                    </tr>
                </table>
