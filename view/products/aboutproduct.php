...
<head>
    ...
    <link rel="stylesheet" href="/layout//css//stylexxx.css" />
...
?>
            ...
            <form action="/project-flower/cart/cart.php" method="POST">
                ...
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img width="500"
                            src="./admin/uploads/<?php echo $showaboutproducts['image'] ?> ">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="fs-5 mb-5">
                            <span
                                style="color: red"><?php echo "Khuyến mãi:" . $showaboutproducts['deal'] . "%" ?></span>
                            <span>
                        </div>
        ...
        <div class="container px-4 px-lg-5 mt-5">
            ...
            <div style=" border-radius: 5px;">
                <form style="text-align:center" action="binhluan.php?id=<?php echo $id; ?>" method="post" en>
                    <input
                        style=" width: 70%;padding: 12px 20px;margin: 8px 0;display: inline-block;border: 1px solid #ccc;border-radius: 4px;box-sizing: border-box;"
                        type="text" name="noidung" required id="fname" placeholder="Nội dung bình luận">
                    <input type="hidden" name="" id="">
                    <input
                        style="width: 70%; background-color: #212529;color: white;padding: 14px 20px;margin: 8px 0;border: none;border-radius: 4px;cursor: pointer;"
            ...
            <div class="row">
                <div class="col-sm-8">
                    ...
                    <form style="margin-bottom: 30px;" action="binhluan.php?id=<?php echo $id; ?>" method="post"
                        ...
                        <h3
                            style=" font-weight: 400; font-size: 20px; color: #555555; margin: 10px 0 15px; padding: 0;">
                        ...
                        <div style="">
                            <div>
                                <div class="form-group">
                                    ...
                                    <input class="border btn btn-success"
                                        style="margin-top: 7px; color: white;padding: 14px 20px;border: none;border-radius: 8px;cursor: pointer;"
                                        type="submit" name="submit" value=" Gửi bình luận">
                                </div>
                            </div>
                    ...
                    <div style=" border-top: 2px dashed #DDDDDD;padding: 20px 0;margin-top: 48px; width: 300px"
                        ...
                        <div class="border-top: 2px dashed #DDDDDD;">
                            ...
                            <p style="font-size: 12px;"><span><svg style="width: 20" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <a class="pull-left" href="#"><img style="width:300px; margin-bottom:48px"
                                    class="media-object"
