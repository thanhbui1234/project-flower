                ...
                <div class="col-md-6">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="">
                            ...
                            <input id="button_add_cart1" type="submit" class="btn btn-outline-dark flex-shrink-0" value="Thêm vào giỏ hàng" name="add_cart">
                            <input id="button_add_cart2" type="submit" class="btn btn-outline-dark flex-shrink-0" value="Mua ngay" name="add_cart">
                        </div>
                    </div>
...
<section style="padding: 30px 0; background-color: #FFFFFF; box-shadow: 0 -1px 6px 1px rgba(0, 0, 0, 0.1);background-color: #FFFFFF;" class="content-item" id="comments">
    <div class="container">
        <div class="row">
            <div class="col-sm-8">
                <?php
                        ...
                        <div>
                            <div>
                                <div class="form-group">
                                    <label class="btn btn-outline-dark flex-shrink-0" for="img" style="padding: 14px 20px;border-radius: 8px;margin-top: 7px;"> Thêm hình ảnh</label>
                                    <!-- <td><img width="100" src="../../uploads//<?php echo $image ?>" alt=""></td> -->
                                    <input class="brg" hidden name="prod_img" type="file" id="img">

                                    <label class="btn btn-outline-dark flex-shrink-0" for="submit" style="padding: 14px 20px;border-radius: 8px;margin-top: 7px;"> Gửi bình luận</label>
