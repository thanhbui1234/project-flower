                        ...
                        <div>
                            <div>
                                <div class="form-group">
                                    <label class="border btn " for="img"
                                    ...
                                    <input class="border btn "
                                        style="margin-top: 7px; color: black;padding: 14px 20px;border: none;border-radius: 8px;cursor: pointer;"
                            ...
                            <div>
                                ...
                                <div>
                                    <h3>Bạn cần <a href="http://localhost/project-flower/login/login.php">đăng nhập</a>
                                        để bình luận</h3>
                                </div>
                                ...
                                <div style=" border-top: 2px dashed #DDDDDD;padding: 20px 0;margin-top: 48px; width: 300px"
                                    ...
                                    <div class="border-top: 2px dashed #DDDDDD;">
                                        ...
                                        <a class="pull-left" href="#"><img style="width:300px; margin-bottom:48px"
                                                class="media-object"
                                                src="/../project-flower/admin/uploads/<?php echo $cmt['img'] ?>"
                                                alt=""></a>
